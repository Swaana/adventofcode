...
// Part 2, run as renderer
// go from left to right per line, and flip boolean isInside on each edge (count | J and 7 as edges, the rest can be ignored)
// count all squares that are not a pipe, and inside
